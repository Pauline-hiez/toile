...
-- forgot-password) — voir App\Core\RateLimiter. Une ligne par tentative ;
-- identifier porte un préfixe ('ip:'/'email:') pour distinguer les deux
-- natures de compteur (par IP et par cible) sans risque de collision.
-- -----------------------------------------------------
