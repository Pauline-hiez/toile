 ...
 * extract($data) (voir AuthController::showRegister()/register()).
 *
 * @var array<string, string> $errors
 * @var array<string, string> $old
 */
$pageTitle = 'Inscription — Toile';
?>

<div class="max-w-[1400px] mx-auto px-5 pt-0 pb-4 min-[641px]:px-10 min-[641px]:pt-0 min-[641px]:pb-6">
    <h1 class="font-title text-shine text-[1.7rem] min-[481px]:text-[2.2rem] text-title font-semibold text-center leading-none mb-0">Créer votre compte</h1>
                    ...
                    <form method="POST" action="/register" class="flex flex-col gap-3 min-[481px]:gap-5">
                        ...
                        <div>
                            ...
                            <?php if (isset($errors['username'])): ?>
                                <p class="text-danger text-[0.7rem] min-[481px]:text-[0.8rem] mt-1"><?= htmlspecialchars($errors['username']) ?></p>
                            <?php endif; ?>
                        </div>
                        ...
                        <div>
                            ...
                            <?php if (isset($errors['email'])): ?>
                                <p class="text-danger text-[0.7rem] min-[481px]:text-[0.8rem] mt-1"><?= htmlspecialchars($errors['email']) ?></p>
                            <?php endif; ?>
                        </div>
                        ...
                        <div>
                            <label for="password_confirm" class="block font-semibold text-[0.8rem] min-[481px]:text-[0.95rem] text-primary mb-1">Confirmation de mot de passe</label>
                            <div class="relative">
                            ...
                            <?php if (isset($errors['password'])): ?>
                                <p class="text-danger text-[0.7rem] min-[481px]:text-[0.8rem] mt-1"><?= htmlspecialchars($errors['password']) ?></p>
                            <?php endif; ?>
                        </div>

                        <div class="text-center mt-1">
                            <button type="submit" class="btn btn--primary px-6 min-[481px]:px-12">M'inscrire</button>
                        </div>
                    </form>
