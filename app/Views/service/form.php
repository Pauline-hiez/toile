...
<head>
    <meta charset="UTF-8">
    <title><?= $service ? 'Modifier' : 'Créer' ?> une prestation — Toile</title>
</head>
...
<body>
    ...
    <form method="POST" action="/my-services/save">
        ...
        <?php
        // On affiche les options déjà existantes, plus 2 lignes vides
        // pour en ajouter facilement de nouvelles.
        $rows = $options;
